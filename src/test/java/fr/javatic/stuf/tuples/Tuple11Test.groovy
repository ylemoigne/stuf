...
import fr.javatic.stuf.consumers.Consumer11
import fr.javatic.stuf.functions.Function11
import spock.lang.Shared
import spock.lang.Specification

class Tuple11Test extends Specification {
    @Shared
    def val = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", null]

    def "Tuple11 equality"() {
        given:
        "Two Tuple11 Try"
        def t1 = new Tuple11(content1A, content1B, content1C, content1D, content1E, content1F, content1G, content1H, content1I, content1J, content1K)
        def t2 = new Tuple11(content2A, content2B, content2C, content2D, content2E, content2F, content2G, content2H, content2I, content2J, content2K)
    ...
    def "Tuple11 values getter"() {
        given:
        "A Tuple11"
        def t = new Tuple11("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k")
    ...
    def "Tuple11 invoke on Function11"() {
        given:
        "A Tuple11"
        def tu = new Tuple11("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k")

        when:
        "I call invoke"
        def ru = tu.invoke({ a, b, c, d, e, f, g, h, i, j, k -> a + b + c + d + e + f + g + h + i + j + k } as Function11)
    ...
    def "Tuple11 invoke on Consumer11"() {
        given:
        "A Tuple2"
        def tu = new Tuple11("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k")
        ...
        "I call invoke"
        def ru = "foo"
        tu.invoke({ a, b, c, d, e, f, g, h, i, j, k -> ru = a + b + c + d + e + f + g + h + i + j + k } as Consumer11)
