...
class Tuple16Test extends Specification {
    @Shared
    def val = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", null]

    def "Tuple16 equality"() {
        given:
        "Two Tuple16 Try"
        def t1 = new Tuple16(content1A, content1B, content1C, content1D, content1E, content1F, content1G, content1H, content1I, content1J, content1K, content1L, content1M, content1N, content1O, content1P)
        def t2 = new Tuple16(content2A, content2B, content2C, content2D, content2E, content2F, content2G, content2H, content2I, content2J, content2K, content2L, content2M, content2N, content2O, content2P)
    ...
    def "Tuple16 values getter"() {
        given:
        "A Tuple16"
        def t = new Tuple16("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p")
    ...
    def "Tuple16 invoke on Function16"() {
        given:
        "A Tuple16"
        def tu = new Tuple16("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p")

        when:
        "I call invoke"
        def ru = tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p -> a + b + c + d + e + f + g + h + i + j + k + l + m + n + o + p } as Function16)
    ...
    def "Tuple16 invoke on Consumer16"() {
        given:
        "A Tuple2"
        def tu = new Tuple16("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p")
        ...
        "I call invoke"
        def ru = "foo"
        tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p -> ru = a + b + c + d + e + f + g + h + i + j + k + l + m + n + o + p } as Consumer16)
