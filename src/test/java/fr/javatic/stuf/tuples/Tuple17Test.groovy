...
import fr.javatic.stuf.consumers.Consumer17
import fr.javatic.stuf.functions.Function17
import spock.lang.Shared
import spock.lang.Specification

class Tuple17Test extends Specification {
    @Shared
    def val = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", null]

    def "Tuple17 equality"() {
        given:
        "Two Tuple17 Try"
        def t1 = new Tuple17(content1A, content1B, content1C, content1D, content1E, content1F, content1G, content1H, content1I, content1J, content1K, content1L, content1M, content1N, content1O, content1P, content1Q)
        def t2 = new Tuple17(content2A, content2B, content2C, content2D, content2E, content2F, content2G, content2H, content2I, content2J, content2K, content2L, content2M, content2N, content2O, content2P, content2Q)
    ...
    def "Tuple17 values getter"() {
        given:
        "A Tuple17"
        def t = new Tuple17("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q")
    ...
    def "Tuple17 invoke on Function17"() {
        given:
        "A Tuple17"
        def tu = new Tuple17("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q")

        when:
        "I call invoke"
        def ru = tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q -> a + b + c + d + e + f + g + h + i + j + k + l + m + n + o + p + q } as Function17)

        then:
        "I should get the returned value by the applied function"
        ru == "abcdefghijklmnopq"
    }

    def "Tuple17 invoke on Consumer17"() {
        given:
        "A Tuple2"
        def tu = new Tuple17("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q")
        ...
        "I call invoke"
        def ru = "foo"
        tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q -> ru = a + b + c + d + e + f + g + h + i + j + k + l + m + n + o + p + q } as Consumer17)
