...
import fr.javatic.stuf.consumers.Consumer22
import fr.javatic.stuf.functions.Function22
import spock.lang.Shared
import spock.lang.Specification

class Tuple22Test extends Specification {
    @Shared
    def val = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", null]

    def "Tuple22 equality"() {
        given:
        "Two Tuple22 Try"
        def t1 = new Tuple22(content1A, content1B, content1C, content1D, content1E, content1F, content1G, content1H, content1I, content1J, content1K, content1L, content1M, content1N, content1O, content1P, content1Q, content1R, content1S, content1T, content1U, content1V)
        def t2 = new Tuple22(content2A, content2B, content2C, content2D, content2E, content2F, content2G, content2H, content2I, content2J, content2K, content2L, content2M, content2N, content2O, content2P, content2Q, content2R, content2S, content2T, content2U, content2V)
    ...
    def "Tuple22 values getter"() {
        given:
        "A Tuple22"
        def t = new Tuple22("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v")
    ...
    def "Tuple22 invoke on Function22"() {
        given:
        "A Tuple22"
        def tu = new Tuple22("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v")

        when:
        "I call invoke"
        def ru = tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v -> a + b + c + d + e + f + g + h + i + j + k + l + m + n + o + p + q + r + s + t + u + v } as Function22)

        then:
        "I should get the returned value by the applied function"
        ru == "abcdefghijklmnopqrstuv"
    }

    def "Tuple22 invoke on Consumer22"() {
        given:
        "A Tuple2"
        def tu = new Tuple22("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v")
        ...
        "I call invoke"
        def ru = "foo"
        tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v -> ru = a + b + c + d + e + f + g + h + i + j + k + l + m + n + o + p + q + r + s + t + u + v } as Consumer22)
