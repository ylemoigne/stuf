...
import fr.javatic.stuf.consumers.Consumer20
import fr.javatic.stuf.functions.Function20
import spock.lang.Shared
import spock.lang.Specification

class Tuple20Test extends Specification {
    @Shared
    def val = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", null]

    def "Tuple20 equality"() {
        given:
        "Two Tuple20 Try"
        def t1 = new Tuple20(content1A, content1B, content1C, content1D, content1E, content1F, content1G, content1H, content1I, content1J, content1K, content1L, content1M, content1N, content1O, content1P, content1Q, content1R, content1S, content1T)
        def t2 = new Tuple20(content2A, content2B, content2C, content2D, content2E, content2F, content2G, content2H, content2I, content2J, content2K, content2L, content2M, content2N, content2O, content2P, content2Q, content2R, content2S, content2T)
    ...
    def "Tuple20 values getter"() {
        given:
        "A Tuple20"
        def t = new Tuple20("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t")
    ...
    def "Tuple20 invoke on Function20"() {
        given:
        "A Tuple20"
        def tu = new Tuple20("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t")

        when:
        "I call invoke"
        def ru = tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t -> a + b + c + d + e + f + g + h + i + j + k + l + m + n + o + p + q + r + s + t } as Function20)

        then:
        "I should get the returned value by the applied function"
        ru == "abcdefghijklmnopqrst"
    }

    def "Tuple20 invoke on Consumer20"() {
        given:
        "A Tuple2"
        def tu = new Tuple20("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t")
        ...
        "I call invoke"
        def ru = "foo"
        tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t -> ru = a + b + c + d + e + f + g + h + i + j + k + l + m + n + o + p + q + r + s + t } as Consumer20)
