...
class Tuple21Test extends Specification {
    @Shared
    def val = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", null]

    def "Tuple21 equality"() {
        given:
        "Two Tuple21 Try"
        def t1 = new Tuple21(content1A, content1B, content1C, content1D, content1E, content1F, content1G, content1H, content1I, content1J, content1K, content1L, content1M, content1N, content1O, content1P, content1Q, content1R, content1S, content1T, content1U)
        def t2 = new Tuple21(content2A, content2B, content2C, content2D, content2E, content2F, content2G, content2H, content2I, content2J, content2K, content2L, content2M, content2N, content2O, content2P, content2Q, content2R, content2S, content2T, content2U)
    ...
    def "Tuple21 values getter"() {
        given:
        "A Tuple21"
        def t = new Tuple21("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u")
    ...
    def "Tuple21 invoke on Function21"() {
        given:
        "A Tuple21"
        def tu = new Tuple21("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u")

        when:
        "I call invoke"
        def ru = tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u -> a + b + c + d + e + f + g + h + i + j + k + l + m + n + o + p + q + r + s + t + u } as Function21)

        then:
        "I should get the returned value by the applied function"
        ru == "abcdefghijklmnopqrstu"
    }

    def "Tuple21 invoke on Consumer21"() {
        given:
        "A Tuple2"
        def tu = new Tuple21("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u")
        ...
        "I call invoke"
        def ru = "foo"
        tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u -> ru = a + b + c + d + e + f + g + h + i + j + k + l + m + n + o + p + q + r + s + t + u } as Consumer21)
