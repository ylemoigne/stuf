...
class Tuple18Test extends Specification {
    @Shared
    def val = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", null]

    def "Tuple18 equality"() {
        given:
        "Two Tuple18 Try"
        def t1 = new Tuple18(content1A, content1B, content1C, content1D, content1E, content1F, content1G, content1H, content1I, content1J, content1K, content1L, content1M, content1N, content1O, content1P, content1Q, content1R)
        def t2 = new Tuple18(content2A, content2B, content2C, content2D, content2E, content2F, content2G, content2H, content2I, content2J, content2K, content2L, content2M, content2N, content2O, content2P, content2Q, content2R)
    ...
    def "Tuple18 values getter"() {
        given:
        "A Tuple18"
        def t = new Tuple18("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r")
    ...
    def "Tuple18 invoke on Function18"() {
        given:
        "A Tuple18"
        def tu = new Tuple18("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r")

        when:
        "I call invoke"
        def ru = tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r -> a + b + c + d + e + f + g + h + i + j + k + l + m + n + o + p + q + r } as Function18)

        then:
        "I should get the returned value by the applied function"
        ru == "abcdefghijklmnopqr"
    }

    def "Tuple18 invoke on Consumer18"() {
        given:
        "A Tuple2"
        def tu = new Tuple18("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r")
        ...
        "I call invoke"
        def ru = "foo"
        tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r -> ru = a + b + c + d + e + f + g + h + i + j + k + l + m + n + o + p + q + r } as Consumer18)
