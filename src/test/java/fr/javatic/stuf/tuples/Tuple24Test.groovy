...
import fr.javatic.stuf.consumers.Consumer24
import fr.javatic.stuf.functions.Function24
import spock.lang.Shared
import spock.lang.Specification

class Tuple24Test extends Specification {
    @Shared
    def val = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", null]

    def "Tuple24 equality"() {
        given:
        "Two Tuple24 Try"
        def t1 = new Tuple24(content1A, content1B, content1C, content1D, content1E, content1F, content1G, content1H, content1I, content1J, content1K, content1L, content1M, content1N, content1O, content1P, content1Q, content1R, content1S, content1T, content1U, content1V, content1W, content1X)
        def t2 = new Tuple24(content2A, content2B, content2C, content2D, content2E, content2F, content2G, content2H, content2I, content2J, content2K, content2L, content2M, content2N, content2O, content2P, content2Q, content2R, content2S, content2T, content2U, content2V, content2W, content2X)
    ...
    def "Tuple24 values getter"() {
        given:
        "A Tuple24"
        def t = new Tuple24("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x")
    ...
    def "Tuple24 invoke on Function24"() {
        given:
        "A Tuple24"
        def tu = new Tuple24("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x")

        when:
        "I call invoke"
        def ru = tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x -> a + b + c + d + e + f + g + h + i + j + k + l + m + n + o + p + q + r + s + t + u + v + w + x } as Function24)

        then:
        "I should get the returned value by the applied function"
        ru == "abcdefghijklmnopqrstuvwx"
    }

    def "Tuple24 invoke on Consumer24"() {
        given:
        "A Tuple2"
        def tu = new Tuple24("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x")
        ...
        "I call invoke"
        def ru = "foo"
        tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x -> ru = a + b + c + d + e + f + g + h + i + j + k + l + m + n + o + p + q + r + s + t + u + v + w + x } as Consumer24)
