...
class Tuple13Test extends Specification {
    @Shared
    def val = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", null]

    def "Tuple13 equality"() {
        given:
        "Two Tuple13 Try"
        def t1 = new Tuple13(content1A, content1B, content1C, content1D, content1E, content1F, content1G, content1H, content1I, content1J, content1K, content1L, content1M)
        def t2 = new Tuple13(content2A, content2B, content2C, content2D, content2E, content2F, content2G, content2H, content2I, content2J, content2K, content2L, content2M)
    ...
    def "Tuple13 values getter"() {
        given:
        "A Tuple13"
        def t = new Tuple13("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m")
    ...
    def "Tuple13 invoke on Function13"() {
        given:
        "A Tuple13"
        def tu = new Tuple13("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m")

        when:
        "I call invoke"
        def ru = tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m -> a + b + c + d + e + f + g + h + i + j + k + l + m } as Function13)
    ...
    def "Tuple13 invoke on Consumer13"() {
        given:
        "A Tuple2"
        def tu = new Tuple13("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m")
        ...
        "I call invoke"
        def ru = "foo"
        tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m -> ru = a + b + c + d + e + f + g + h + i + j + k + l + m } as Consumer13)
