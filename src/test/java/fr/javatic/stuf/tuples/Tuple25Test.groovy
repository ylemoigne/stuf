...
import fr.javatic.stuf.consumers.Consumer25
import fr.javatic.stuf.functions.Function25
import spock.lang.Shared
import spock.lang.Specification

class Tuple25Test extends Specification {
    @Shared
    def val = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", null]

    def "Tuple25 equality"() {
        given:
        "Two Tuple25 Try"
        def t1 = new Tuple25(content1A, content1B, content1C, content1D, content1E, content1F, content1G, content1H, content1I, content1J, content1K, content1L, content1M, content1N, content1O, content1P, content1Q, content1R, content1S, content1T, content1U, content1V, content1W, content1X, content1Y)
        def t2 = new Tuple25(content2A, content2B, content2C, content2D, content2E, content2F, content2G, content2H, content2I, content2J, content2K, content2L, content2M, content2N, content2O, content2P, content2Q, content2R, content2S, content2T, content2U, content2V, content2W, content2X, content2Y)
    ...
    def "Tuple25 values getter"() {
        given:
        "A Tuple25"
        def t = new Tuple25("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y")
    ...
    def "Tuple25 invoke on Function25"() {
        given:
        "A Tuple25"
        def tu = new Tuple25("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y")

        when:
        "I call invoke"
        def ru = tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y -> a + b + c + d + e + f + g + h + i + j + k + l + m + n + o + p + q + r + s + t + u + v + w + x + y } as Function25)
    ...
    def "Tuple25 invoke on Consumer25"() {
        given:
        "A Tuple2"
        def tu = new Tuple25("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y")
        ...
        "I call invoke"
        def ru = "foo"
        tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y -> ru = a + b + c + d + e + f + g + h + i + j + k + l + m + n + o + p + q + r + s + t + u + v + w + x + y } as Consumer25)
