...
import fr.javatic.stuf.consumers.Consumer19
import fr.javatic.stuf.functions.Function19
import spock.lang.Shared
import spock.lang.Specification

class Tuple19Test extends Specification {
    @Shared
    def val = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", null]

    def "Tuple19 equality"() {
        given:
        "Two Tuple19 Try"
        def t1 = new Tuple19(content1A, content1B, content1C, content1D, content1E, content1F, content1G, content1H, content1I, content1J, content1K, content1L, content1M, content1N, content1O, content1P, content1Q, content1R, content1S)
        def t2 = new Tuple19(content2A, content2B, content2C, content2D, content2E, content2F, content2G, content2H, content2I, content2J, content2K, content2L, content2M, content2N, content2O, content2P, content2Q, content2R, content2S)
    ...
    def "Tuple19 values getter"() {
        given:
        "A Tuple19"
        def t = new Tuple19("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s")
    ...
    def "Tuple19 invoke on Function19"() {
        given:
        "A Tuple19"
        def tu = new Tuple19("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s")

        when:
        "I call invoke"
        def ru = tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s -> a + b + c + d + e + f + g + h + i + j + k + l + m + n + o + p + q + r + s } as Function19)

        then:
        "I should get the returned value by the applied function"
        ru == "abcdefghijklmnopqrs"
    }

    def "Tuple19 invoke on Consumer19"() {
        given:
        "A Tuple2"
        def tu = new Tuple19("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s")
        ...
        "I call invoke"
        def ru = "foo"
        tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s -> ru = a + b + c + d + e + f + g + h + i + j + k + l + m + n + o + p + q + r + s } as Consumer19)
