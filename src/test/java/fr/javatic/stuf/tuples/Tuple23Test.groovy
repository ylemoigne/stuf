...
import fr.javatic.stuf.consumers.Consumer23
import fr.javatic.stuf.functions.Function23
import spock.lang.Shared
import spock.lang.Specification

class Tuple23Test extends Specification {
    @Shared
    def val = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", null]

    def "Tuple23 equality"() {
        given:
        "Two Tuple23 Try"
        def t1 = new Tuple23(content1A, content1B, content1C, content1D, content1E, content1F, content1G, content1H, content1I, content1J, content1K, content1L, content1M, content1N, content1O, content1P, content1Q, content1R, content1S, content1T, content1U, content1V, content1W)
        def t2 = new Tuple23(content2A, content2B, content2C, content2D, content2E, content2F, content2G, content2H, content2I, content2J, content2K, content2L, content2M, content2N, content2O, content2P, content2Q, content2R, content2S, content2T, content2U, content2V, content2W)
    ...
    def "Tuple23 values getter"() {
        given:
        "A Tuple23"
        def t = new Tuple23("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w")
    ...
    def "Tuple23 invoke on Function23"() {
        given:
        "A Tuple23"
        def tu = new Tuple23("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w")

        when:
        "I call invoke"
        def ru = tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w -> a + b + c + d + e + f + g + h + i + j + k + l + m + n + o + p + q + r + s + t + u + v + w } as Function23)
    ...
    def "Tuple23 invoke on Consumer23"() {
        given:
        "A Tuple2"
        def tu = new Tuple23("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w")
        ...
        "I call invoke"
        def ru = "foo"
        tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w -> ru = a + b + c + d + e + f + g + h + i + j + k + l + m + n + o + p + q + r + s + t + u + v + w } as Consumer23)
