...
import fr.javatic.stuf.consumers.Consumer15
import fr.javatic.stuf.functions.Function15
import spock.lang.Shared
import spock.lang.Specification

class Tuple15Test extends Specification {
    @Shared
    def val = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", null]

    def "Tuple15 equality"() {
        given:
        "Two Tuple15 Try"
        def t1 = new Tuple15(content1A, content1B, content1C, content1D, content1E, content1F, content1G, content1H, content1I, content1J, content1K, content1L, content1M, content1N, content1O)
        def t2 = new Tuple15(content2A, content2B, content2C, content2D, content2E, content2F, content2G, content2H, content2I, content2J, content2K, content2L, content2M, content2N, content2O)
    ...
    def "Tuple15 values getter"() {
        given:
        "A Tuple15"
        def t = new Tuple15("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o")
    ...
    def "Tuple15 invoke on Function15"() {
        given:
        "A Tuple15"
        def tu = new Tuple15("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o")

        when:
        "I call invoke"
        def ru = tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m, n, o -> a + b + c + d + e + f + g + h + i + j + k + l + m + n + o } as Function15)
    ...
    def "Tuple15 invoke on Consumer15"() {
        given:
        "A Tuple2"
        def tu = new Tuple15("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o")
        ...
        "I call invoke"
        def ru = "foo"
        tu.invoke({ a, b, c, d, e, f, g, h, i, j, k, l, m, n, o -> ru = a + b + c + d + e + f + g + h + i + j + k + l + m + n + o } as Consumer15)
